    ...
    chatNow(i) {
        ...
        this.platform.ready().then(() => {
            if (typeof cordova !== 'undefined') {
                const browser = cordova.InAppBrowser.open('https://nima.lottosocial.com/webview-auth/?redirect_to=' + this.syndArr[i].peepso_group_url + '&customer_id=' + this.customer_id + '&customer_token=' + this.customerToken + '', '_blank', 'location=no,toolbarposition=top');
